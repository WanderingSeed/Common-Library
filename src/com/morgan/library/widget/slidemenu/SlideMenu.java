...
public class SlideMenu extends ViewGroup {
    ...
    public void addView(View child, int index, android.view.ViewGroup.LayoutParams params) {
        if (!(params instanceof LayoutParams)) {
            throw new IllegalArgumentException("LayoutParams must a instance of LayoutParams");
        }
    ...
    /**
     * Remove view child it's parent node, if the view does not have parent. ignore
     * 
     * @param view
     */
    ...
    /**
     * Get current slide direction, {@link #FLAG_DIRECTION_LEFT}, {@link #FLAG_DIRECTION_RIGHT} or
     * {@link #FLAG_DIRECTION_LEFT}| {@link #FLAG_DIRECTION_RIGHT}
     * 
     * @return
     */
    ...
    private void setCurrentOffset(int currentOffset) {
        ...
        mCurrentContentOffset = Math.min(
                (slideDirectionFlag & FLAG_DIRECTION_RIGHT) == FLAG_DIRECTION_RIGHT ? mContentBoundsRight : 0, Math
                        .max(currentOffset,
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int index = 0; index < count; index++) {
            ...
            case LayoutParams.ROLE_PRIMARY_MENU:
                ...
                child.layout(paddingLeft - primaryOffset, statusBarHeight + paddingTop, paddingLeft + measureWidth
                        - primaryOffset, statusBarHeight + paddingTop + measureHeight);
                break;
            case LayoutParams.ROLE_SECONDARY_MENU:
                mContentBoundsLeft = -measureWidth;
                child.layout(r - paddingRight - measureWidth + secondaryOffect, statusBarHeight + paddingTop, r
                        - paddingRight + secondaryOffect, statusBarHeight + t + measureHeight);
                break;
            default:
                continue;
            }
        ...
        if (v instanceof ViewGroup) {
            ...
            for (int index = 0; index < childCount; index++) {
                ...
                if (x + scrollX >= left
                        ...
                        && (ScrollDetectors.canScrollHorizontal(child, dx) || canScroll(child, dx, x + scrollX - left,
                                y + scrollY - top))) {
                    return true;
                }
            }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            ...
            for (int index = 0; index < indexCount; index++) {
                if (a.getIndex(index) == R.styleable.SlideMenu_Layout_layout_role) {
    ...
    public interface OnSlideStateChangeListener {
         ...
         * 
         * @param slideState
         *            {@link SlideMenu#STATE_CLOSE},{@link SlideMenu#STATE_OPEN} ,{@link SlideMenu#STATE_DRAG},
