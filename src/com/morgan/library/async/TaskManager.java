...
/**
 * 在应用运行过程中，Activity或Fragment已经被销毁而在它们内部启动的一些异步线程却没有被销毁，当这些线程回调时就会出现一些意想不到的错误， 该类就是用来解决这类问题的。
 * 你所需要做的是，让你的异步线程或那些会启动异步线程的widget实现{@link Destroyable} 接口,然后把这些对象通过 {@link #addItem(String, DestroyAble)}
