...
/**
 * This class implement IHttpSend interface, sample implement send request by post or get method in both TCP and UDP
 * Protocol.
 * 
 * @author Morgan.Ji
 */
    ...
    public String postFile(String url, Map<String, String> params, Map<String, File> files) {
        ...
        try {
            ...
            for (Map.Entry<String, String> entry : params.entrySet()) {
                ...
                headPara.append("Content-Disposition: form-data; name=\"" + entry.getKey() + "\"" + LINEND);
                headPara.append(LINEND);
            ...
            if (files != null) {
                for (Map.Entry<String, File> file : files.entrySet()) {
                    ...
                    headFilePara.append("Content-Disposition: form-data; name=\"flow\"; filename=\""
                            + file.getValue().getName() + "\"" + LINEND);
                    headFilePara.append("Content-Type: application/octet-stream; charset=" + UTF_8 + LINEND);
                    headFilePara.append(LINEND);
